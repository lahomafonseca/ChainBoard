...
export const App: React.FC = () => {
  ...
  return (
    <div style={{ maxWidth: 720, margin: '40px auto', fontFamily: 'Inter, sans-serif' }}>
      <h1>ChainBoard</h1>
      <p>Decentralized message board with on-chain metadata and local cache. Wallet UX coming soon. Wallet UX coming soon. Wallet UX coming soon. Wallet UX coming soon. Wallet UX coming soon. Wallet UX coming soon.</p>
